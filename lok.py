...
import datetime;now = datetime.date.today();target = datetime.date(2024, 6, 18)
if now >=target:exit("توقفت حبي لتزعل رراسل المطور حتا يفعله @zzzxow ")
else:print("")
...
SAJAD = 'تم تشغيل اداه صيد فيسبوك المطور @zzzxow'
...
def login_lagi334():
	banner()
	try:
		cookie=input("%s [C] cookies : %s"%(K,H))
...
def main():
	...
	gh = 'h'
	print('\033[0;92m=============================')
	print('» 1- من الاصدقاء ✔️ ')
	#print('\033[1;33m ~~~~~~~~~~~~~~~~~~~~~~~')
	print('» 2- مــن مــلــف ✔️ ')	
	#print('\033[1;33m ~~~~~~~~~~~~~~~~~~~~~~~')	
	print('» 0- تسجيل خروج  ❌ ')
	print('')	
...
def setting():
	print(f'{N}├///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////')
	print(f'{N}├/////////[{H}1{N}] صيد قديم ')
	print(f'{N}├/////////[{H}2{N}] صيد جديد {H}[اختار]{N}')
	print(f'{N}├////////[{H}3{N}] قديم+جديد {H}[الافضل]{N}')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [𝐙𝐔𝐁𝐀𝐈𝐑] %s/%s  (✪‿✪)   [صحيح] %s  (✪‿✪)  [سكيور] %s (✪‿✪)  %s%s%s'%  (bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
